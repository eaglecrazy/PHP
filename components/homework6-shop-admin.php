<?php
$main_start = '<form class="add-item" action="../homework6-shop-add-item.php" method="POST" enctype="multipart/form-data">
...
foreach ($data as $item) {
    ...
    <td class=\"table-cell table-cell-edit\"><a class=\"table-link-edit\" href=\"homework6-shop-admin-edit-page.php?id=$item[id]\"><img src=\"../img/edit.png\" alt=\"edit\"></a></td>
    <td class=\"table-cell table-cell-delete\"><a class=\"table-link-delete\" href=\"homework6-shop-delete-item.php?id=$item[id]\"><img src=\"../img/delete.png\" alt=\"delete\"></a></td>
</tr>";
}
