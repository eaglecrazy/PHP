...
$h1 = "minimalistica";
$title = "minimalistica";
$date = date("Y");//вообще тут года не было, но я его добавил там где копирайт
?>
...
<body>
	<div id="content">
		...
		<div id="footer">
			<p>Copyright &copy; <em>minimalistica</em> <?php echo $date; ?>  &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>
		</div>	
	</div>
</body>
</html>
